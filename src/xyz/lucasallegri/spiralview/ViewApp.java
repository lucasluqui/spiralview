...
public class ViewApp implements Runnable {
	...
	public void run() {
		...
		String jvm = "java_vm" + File.separator + "bin" + File.separator + "java";
		...
		String[] command = new String[] { jvm, "-Djava.library.path=native", "-cp", classPath, targetClass, "rsrc" + File.separator + "character" + File.separator + "pc" + File.separator + "model.dat" };
