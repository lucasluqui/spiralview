  ...
  implements ActionListener
{
   ...
   */
  public void setParameterLabel (String label, String parameterInfo)
  {
  ...
  protected Color getDarkerBackground (float shades)
  {
    ...
    return darkenColor(DEFAULT_BACKGROUND, shades);
  }
  ...
  protected static final int BASE_BACKGROUND = new Color(60, 63, 65).getRGB();

  /** The default background value. */
  protected static final int DEFAULT_BACKGROUND = new Color(60, 63, 65).getRGB();
